...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/janta.css') }}">
    <!-- Bootstrap CSS -->
...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="{{ asset(Auth::user()->avatar) }}" class="user-img-radious-style"> <span
    ...
    <!-- =======Frontend JS File======= -->
    <script src="{{ asset('assets/js/codeplus.js') }}"></script>
</body>
